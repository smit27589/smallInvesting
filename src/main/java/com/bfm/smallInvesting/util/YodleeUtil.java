  ...
  private static String REMOVE_ITEM = "v1.0/jsonsdk/ItemAccountManagement/removeItem";
	...
	public static String getToken(String cobrandSessionToken, String userSessionToken, String finAppId) {
	    ...
	    try {
	      ...
	      pm.addParameter(paramNameUserRSessionToken, userSessionToken);
	      ...
	      try {
	          jsonObject = jsonObject
	            .getJSONObject("finappAuthenticationInfos");
	        } catch(Exception e) {
	          JSONArray infoArray = jsonObject
	          .getJSONArray("finappAuthenticationInfos");
	...
	public static String loginCobrand(String cobrandLoginValue,
	...
	public static String transactionSearchService(String cobrandSessionToken,
	  ...
	  String transactionsJSON = null;
		...
		try {
			...
			transactionsJSON = pm.getResponseBodyAsString();
